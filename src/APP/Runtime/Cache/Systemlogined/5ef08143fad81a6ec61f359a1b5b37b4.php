									...
									<div class="tab-content">
										<div id="home" class="tab-pane in active">
                                            ...
                                            <div class="control-group" >
														...
														<div class="controls">
															...
															<font color="red">已购--此处设置推荐别人购买太阳能光伏时，自己已持有太阳能光伏，获得奖励多。</font>
                                                        </div>
												<div style="height: 20px;"></div>
														<div class="controls">
															...
															<font color="red">未购--此处设置推荐别人购买太阳能光伏时，自己未持有太阳能光伏，获得奖励少。</font>
                                                        </div>
											</div>
												<div class="control-group" >
												...
												<div class="control-group" >
													...
													<div class="controls">
														直推太阳能光伏数量<input type="text" id="chengzhu" name="chengzhu" value="<?php echo ($config["chengzhu"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">设置直推拥有多少太阳能光伏可以升级为城主。</font>
												...
												<div class="control-group">
													<label class="control-label" for="faquan">发圈赠送太阳能光伏编号</label>
													<div class="controls">
														<input type="text" id="faquan" name="faquan" value="<?php echo ($config["faquan"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">此处修改金币兑换太阳能光伏的编号。</font>&nbsp;&nbsp;
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														金币兑换<input type="text" id="duihuan" name="duihuan" value="<?php echo ($config["duihuan"]); ?>" style=" width: 100px;" class="span3"/>&nbsp;&nbsp;<font color="red">设置兑换太阳能光伏需要的金币数量。</font>
													</div>
												</div>
												<!--<div class="control-group">
                                            ...
                                            <div class="control-group">
														<label class="control-label" for="jiesuan_time">太阳能光伏结算时间间隔</label>
										...
										<div id="memberconf" class="tab-pane">
											...
											<form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/System/memberConf');?>" method="post">
												<div class="control-group">
													<label class="control-label" for="code_account">飞鸽短信账号</label>
												...
												<div class="control-group">
													<label class="control-label" for="code_password">飞鸽短信KEY</label>
												...
												<div class="control-group">
													<label class="control-label" for="code_templateid">飞鸽短信模板ID</label>

													<div class="controls">
														<input type="text" id="code_templateid" name="code_templateid" value="<?php echo ($config["CODE_TEMPLATEID"]); ?>" class="span3"/><span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													<label class="control-label" for="code_templateid">飞鸽签名ID</label>

													<div class="controls">
														<input type="text" id="code_signid" name="code_signid" value="<?php echo ($config["CODE_SIGNID"]); ?>" class="span3"/><span class="help-inline"></span>
													</div>
												</div>												
